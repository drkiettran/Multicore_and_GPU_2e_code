/*
 ...
 Description   : Multi-threaded image matching
 To compile    : qmake imageMatch.pro; make
 ============================================================================
 */
#include <iostream>
#include <stdio.h>
...
int main (int argc, char *argv[])
{
  ...
  QtConcurrent::blockingMap (pool, Image::calcProb);

  // mutual information (MI) calculation
  QtConcurrent::blockingMap (pool, bind (Image::mutualInformation, placeholders::_1, &target));
