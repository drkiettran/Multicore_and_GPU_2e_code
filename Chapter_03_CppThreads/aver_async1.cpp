/*
 ...
 Description   : 
 To compile    : g++ aver_async1.cpp -o aver_async1 -pthread
 ============================================================================
 */
...
public:
  Aver (vector < double >::iterator s, vector < double >::iterator e):start (s), end (e) {}
  double partialSum ()
  {
    double partialRes = 0;
  ...
  for (int i = 0; i < numThr; i++)
    {
      ...
      if (i == numThr - 1)
        localEnd = data.end ();
      Aver temp (localStart, localEnd);
      f[i] = async (&Aver::partialSum, temp);
      localStart += step;
    }
